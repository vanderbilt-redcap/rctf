...
Given("I select the User Right named {string} and choose {string}", (text, option) => {
    ...
    if(text === "Data Exports" && window.compareVersions.compare(Cypress.exposeRCTF('redcap_version'), '12.0.0', '>=')){
 ...
 * @param {string} dataViewingRights
 * @param {string} editSurveyRights
