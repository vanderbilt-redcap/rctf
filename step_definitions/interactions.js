 ...
 * @param {action} action - available options: 'click on', 'check', 'uncheck', 'should see', 'should NOT see'
 ...
 * @param {optionalQuotedString} columnLabel - available options: '', 'in the Matrix column'
